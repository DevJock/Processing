...
public class sketch_3CH_OSCC extends PApplet {
...
short portIndex = 7; /* determines the USB port used */
...
public void setup()
  {
    ...
    size(1024, 1024); /* smaller screen => less to calculate => no delay problems */
    myPort = new Serial(this,"/dev/tty.usbmodem1451", 9600); /* Open the port that the board is connected to and use the same speed (9600 bps) */
    ...
    zoom = 2.0f; /* Start with 1x zoom factor */
...
public void draw()
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_3CH_OSCC" };
    if (passedArgs != null) {
