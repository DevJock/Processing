...
public class RoVER_Mission_Control extends PApplet {
...
public void serialEvent(Serial port)
{
  ...
  vcc=PApplet.parseFloat(vc)/100.0f;
  temp=PApplet.parseFloat(tc)/10.0f;
  GD=PApplet.parseBoolean(PApplet.parseInt(tgd));
...
public void clock()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RoVER_Mission_Control" };
    if (passedArgs != null) {
